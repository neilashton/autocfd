  ...
  <div class="organizer-grid">
    <article class="organizer-card">
      <div class="organizer-card__portrait">
        <img class="organizer-card__photo organizer-card__photo--portrait" alt="Neil Ashton" src="{{ site.baseurl }}/assets/img/people/nashton-small.jpeg" width="267" height="357" loading="lazy" decoding="async">
      </div>
    ...
    <article class="organizer-card">
      <div class="organizer-card__portrait">
        <img class="organizer-card__photo organizer-card__photo--portrait" alt="Gary Page" src="{{ site.baseurl }}/assets/img/people/page.jpeg" width="601" height="768" loading="lazy" decoding="async">
      </div>
      <div class="organizer-card__info">
        <h3>Gary Page</h3>
        <p class="organizer-card__affiliation">Loughborough University</p>
        <div class="organizer-card__links" role="group" aria-label="Gary Page contact and profiles">
          <a href="mailto:g.j.page@lboro.ac.uk" title="Email Gary Page" aria-label="Email Gary Page"><i class="fas fa-envelope" aria-hidden="true"></i></a>
          <a href="https://orcid.org/0000-0002-6222-892X" title="Gary Page ORCID profile" aria-label="Gary Page ORCID profile"><i class="fab fa-orcid" aria-hidden="true"></i></a>
        </div>
      </div>
    </article>
    ...
    <article class="organizer-card">
      <div class="organizer-card__portrait organizer-card__portrait--inset">
        <img class="organizer-card__photo" alt="Vangelis Skaperdas" src="{{ site.baseurl }}/assets/img/people/vangelis.jpeg" width="246" height="246" loading="lazy" decoding="async">
      </div>
      <div class="organizer-card__info">
        <h3>Vangelis Skaperdas</h3>
        <p class="organizer-card__affiliation">BETA-CAE Systems</p>
        <div class="organizer-card__links" role="group" aria-label="Vangelis Skaperdas contact">
          <a href="mailto:vangelis@cadence.com" title="Email Vangelis Skaperdas" aria-label="Email Vangelis Skaperdas"><i class="fas fa-envelope" aria-hidden="true"></i></a>
        </div>
      </div>
    </article>
    ...
    <article class="organizer-card">
      <div class="organizer-card__portrait">
        <img class="organizer-card__photo" alt="Ben Thornber" src="{{ site.baseurl }}/assets/img/people/ben.jpeg" width="800" height="800" loading="lazy" decoding="async">
      </div>
      <div class="organizer-card__info">
        <h3>Ben Thornber</h3>
        <p class="organizer-card__affiliation">Queen's University Belfast</p>
        <div class="organizer-card__links" role="group" aria-label="Ben Thornber contact and profiles">
          <a href="mailto:b.thornber@qub.ac.uk" title="Email Ben Thornber" aria-label="Email Ben Thornber"><i class="fas fa-envelope" aria-hidden="true"></i></a>
          <a href="https://orcid.org/0000-0002-7665-089X" title="Ben Thornber ORCID profile" aria-label="Ben Thornber ORCID profile"><i class="fab fa-orcid" aria-hidden="true"></i></a>
        </div>
      </div>
    </article>
